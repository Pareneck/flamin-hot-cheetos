...
extern ValveSDK::CHLClient*         client;
extern ValveSDK::IEngineClient*     engine;
extern ValveSDK::IClientEntityList* entitylist;
extern ValveSDK::ISurface*          surface;
extern ValveSDK::IPanel*            panel;
extern ValveSDK::IVDebugOverlay*    debugoverlay;
extern ValveSDK::IEngineTrace*      enginetrace;
extern ValveSDK::CInput*            input;
...
public:
	...
	bool isVisible(ValveSDK::Vector& start, ValveSDK::Vector& end, ValveSDK::CBaseEntity* entity);
	ValveSDK::CBaseCombatWeapon* getActiveWeapon(ValveSDK::CBaseEntity* entity);
	bool WorldToScreen(ValveSDK::Vector& world, ValveSDK::Vector& screen);
	void VectorTransform(const ValveSDK::Vector& in1, const matrix3x4& in2, ValveSDK::Vector& out);
}; extern Tools tools;
